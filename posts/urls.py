...
from .views import UserProductsListView , PostListView, PostView, DetailView, UpdateView, MessageView, DeleteView,BoughtProductsListView,CartListView
from . import views
...
urlpatterns = [
    ...
    path('cart/', CartListView.as_view(), name='bought-products'),
]
